      ...
      de: {
        ...
        pages: {
          ...
          documents: {
            ...
            stornoHint: 'Wenn nach der Finalisierung Korrekturen erforderlich sind, können Sie eine Storno (Gutschrift) erstellen.',
            createStorno: 'Gutschrift erstellen',
            createStornoTitle: 'Gutschrift (Storno) erstellen',
            stornoDesc: 'Dies erstellt eine Gutschrift, die die ursprüngliche Rechnung storniert. Die Gutschrift wird negative Beträge haben.',
            stornoReason: 'Grund für die Gutschrift',
            stornoReasonPlaceholder: 'Z.B. Retoure, Preisfehler, etc.',
            stornoCreated: 'Gutschrift erfolgreich erstellt',
            stornoOf: 'Storno von',
            reason: 'Grund',
            reasonRequired: 'Bitte geben Sie einen Grund für die Gutschrift an',
            mustFinalizeFirst: 'Rechnung muss vor Erstellung einer Storno finalisiert werden',
            cannotStornoStorno: 'Kann keine Storno einer Gutschrift erstellen',
            invoice: 'Rechnung',
            customer: 'Kunde',
            total: 'Gesamt',
            amount: 'Betrag',
      ...
      en: {
        ...
        pages: {
          ...
          documents: {
            ...
            stornoHint: 'If corrections are needed after finalization, you can create a Storno (credit note).',
            createStorno: 'Create Credit Note',
            createStornoTitle: 'Create Credit Note (Storno)',
            stornoDesc: 'This will create a credit note that reverses the original invoice. The credit note will have negative amounts.',
            stornoReason: 'Reason for Credit Note',
            stornoReasonPlaceholder: 'E.g., Customer returned goods, pricing error, etc.',
            stornoCreated: 'Credit note created successfully',
            stornoOf: 'Storno of',
            reason: 'Reason',
            reasonRequired: 'Please provide a reason for the credit note',
            mustFinalizeFirst: 'Invoice must be finalized before creating a Storno',
            cannotStornoStorno: 'Cannot create Storno of a credit note',
            invoice: 'Invoice',
            customer: 'Customer',
            total: 'Total',
            amount: 'Amount',
      ...
      ro: {
        ...
        pages: {
          ...
          documents: {
            ...
            stornoHint: 'Dacă sunt necesare corecții după finalizare, puteți crea o Storno (notă de credit).',
            createStorno: 'Creează Notă de Credit',
            createStornoTitle: 'Creează Notă de Credit (Storno)',
            stornoDesc: 'Aceasta va crea o notă de credit care anulează factura originală. Nota de credit va avea sume negative.',
            stornoReason: 'Motivul pentru nota de credit',
            stornoReasonPlaceholder: 'Ex: Returnare mărfuri, eroare de preț, etc.',
            stornoCreated: 'Notă de credit creată cu succes',
            stornoOf: 'Storno pentru',
            reason: 'Motiv',
            reasonRequired: 'Vă rugăm să furnizați un motiv pentru nota de credit',
            mustFinalizeFirst: 'Factura trebuie finalizată înainte de a crea o Storno',
            cannotStornoStorno: 'Nu se poate crea Storno pentru o notă de credit',
            invoice: 'Factură',
            customer: 'Client',
            total: 'Total',
            amount: 'Sumă',
            creditAmount: 'Sumă credit',
