            ...
            ${pos.length > 0 ? pos.map(po => `
              <tr>
                ...
                <td style="text-align:right;">
                  ...
                  <button class="btn btn-ghost btn-receive-po" data-id="${po.id}" title="Receive" ${po.status === 'received' || po.status === 'closed' ? 'disabled' : ''}>📥</button>
                  <button class="btn btn-ghost btn-view-po" data-id="${po.id}" title="View">👁️</button>
                </td>
              </tr>
