...
App.UI.Sidebar = {
  routes: [
    ...
    { id: 'purchaseOrders', icon: 'orders', labelKey: 'sidebar.purchaseOrders' },
  ...
  rolePermissions(role) {
    switch (role) {
      ...
      case 'warehouse':
      case 'user':
        return new Set(['dashboard','inventory','movements','batches','components','suppliers','carriers','purchaseOrders','production','tasks']);
      case 'production':
